# Generated by Django 5.2.12 on 2026-04-15 00:13
...
def fix_reopened_completed_tv_seasons(apps, _):
    """Remove bad planning seasons created by 0109 and restore affected TVs."""
    ...
    # 0109 created plain Planning seasons without history. If those seasons also
    ...
    with transaction.atomic():
        ...
        for tv_id, tv_seasons in seasons_by_tv_id.items():
            ...
            latest_history = (
                HistoricalTV.objects.filter(id=tv.id)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("app", "0116_podcastepisode_uuid_fix"),
    ]
